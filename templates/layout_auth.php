...
<style type="text/tailwindcss">
  @layer components {
    ...
    .brand-logo { @apply w-10 h-10 rounded-xl bg-gradient-to-br from-brand-600 to-brand-800 text-white grid place-items-center shadow-sm; }
  }
  @media print { .no-print { display: none !important; } }
</style>
</head>
<body class="min-h-screen text-ink-900 font-sans antialiased relative overflow-x-hidden"
      style="background:
        radial-gradient(ellipse 800px 600px at 10% -10%, rgba(14,116,144,0.08), transparent 60%),
        radial-gradient(ellipse 800px 600px at 110% 10%, rgba(6,182,212,0.06), transparent 60%),
